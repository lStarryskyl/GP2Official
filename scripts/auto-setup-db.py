#!/usr/bin/env python3
"""Auto setup database tables for GP2Official - simplified version"""
...
def create_supabase_tables():
    """Create Supabase database tables automatically."""
    print("GP2Official Database Auto-Setup")
    print("=" * 40)
    ...
    database_sql = '''-- GP2Official Database Schema
...
AND NOT EXISTS (SELECT 1 FROM projects WHERE name = 'AI Project Planner');'''
    ...
    # Save SQL to file
    sql_file = Path(__file__).parent.parent / "database-setup.sql"
    ...
    print()
    print("2. Copy the SQL from the file:")
    print(f"   {sql_file}")
    print()
    print("3. Paste it in the editor and click 'RUN'")
    print()
    print("That's it! Database will be ready for deployment.")
    print()
    print("Next Steps:")
    print("- Deploy backend to Render")
    print("- Deploy frontend to Netlify")
    print("- Login with: demo@gp2official.com / demo123")
